<?php
    ...
    class OrderController extends Controller
    {
         ...
         */
        public function __construct (Order $orderObj, Distance $distanceObj, Messages $messages, Helper $helper,Validator $validator)
        {
        ...
        public function createOrder (Request $request)
        {
            ...
            try {
                ...
                $validatorResponse = $this->validator->validateInputParameters($startLatitude,$startLongitude,$endLatitude,$endLongitude);
                ...
                $distance = $this->helper->calculateDistance($startLatitude,$startLongitude,$endLatitude,$endLongitude);
        ...
        public function updateOrder (Request $request, $id)
        {
            ...
            try {
                if ( !isset($request->status) || 'TAKEN' !== $request->status ) {
                    return response()->json(['error' => $this->messages->getMessages('status_is_invalid')], 206);
                }
               ...
               if(isset($getQueryParams[0])) {
                ...
                if ( !empty($records) ) {
                    ...
                    foreach ($records as $record) {
                        ...
                        $item = array(self::ID => $record->id, self::DISTANCE => $distance, self::STATUS=>$record->status);
